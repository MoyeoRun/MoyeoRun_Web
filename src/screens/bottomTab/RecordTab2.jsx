...
const RecordTab2 = () => {
  ...
  return (
    <Box css={RecordTab2Wrapper}>
      {/* 탭 */}
      <Text className="title">기록</Text>
      <Tabs
        value={mode}
        onChange={(event, newValue) => {
          if (pathname === '/test/recordTab2') setMode(newValue);
          else
            window.ReactNativeWebView.postMessage(
...
export default RecordTab2;

const RecordTab2Wrapper = css`
  height: 100%;
  display: flex;
